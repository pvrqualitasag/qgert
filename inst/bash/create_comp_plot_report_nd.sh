...
###
###
###   Purpose:   Creation of comparison plot report for ND
...
Rscript -e "zwsroutinetools::create_ge_compare_plot_report_nd(pn_cur_ge_label=$CURGE, pn_prev_ge_label = $PREVGE, pb_debug=TRUE)"
