...
## -- Creator Function for CARCASS SMT ----------------------------------------- ##

#' @title Comparison Plot Report Creator Function For Production (CARCASS SMT)
#'
#' @description
...
#' }
#'
#' @export create_ge_compare_plot_report_carcass_smt
create_ge_compare_plot_report_carcass_smt <- function(pn_cur_ge_label,
                                              pn_prev_ge_label,
  ...
  if (pb_debug) {
    if (is.null(plogger)){
      lgr <- get_qgert_logger(ps_logfile = 'create_ge_compare_plot_report_carcass_smt.log', ps_level = 'INFO')
    } else {
      lgr <- plogger
    }
    qgert_log_info(plogger = lgr, ps_caller = 'create_ge_plot_report',
                   ps_msg = " Start of function create_ge_compare_plot_report_carcass_smt ... ")
    qgert_log_info(plogger = lgr, ps_caller = "create_ge_compare_plot_report_carcass_smt",
  ...
  if (pb_debug)
    qgert_log_info(plogger = lgr, ps_caller = "create_ge_compare_plot_report_carcass_smt",
             ps_msg    = " * End of function create_ge_compare_plot_report_carcass_smt")
