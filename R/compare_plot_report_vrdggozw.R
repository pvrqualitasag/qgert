...
create_ge_compare_plot_report_vrdggozw <- function(pn_cur_ge_label,
                                                   pn_prev_ge_label,
                                                   ps_prevgsrun_label,
  ...
  if (pb_debug) {
    if (is.null(plogger)){
      lgr <- get_qgert_logger(ps_logfile = 'create_ge_compare_plot_report_vrdggozw.log', ps_level = 'INFO')
    } else {
      lgr <- plogger
    }
    ...
    qgert_log_info(plogger = lgr, ps_caller = "create_ge_compare_plot_report_vrdggozw",
